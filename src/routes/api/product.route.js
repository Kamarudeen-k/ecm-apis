...
router.get('/products/:product_id/reviews', ProductController.getReviewsOfProduct);
router.post('/products/:product_id/reviews', ProductController.addReviewsOfProduct);
